...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { average_high_f: @temperature.average_high_f, average_low_f: @temperature.average_low_f, month: @temperature.month } }, as: :json
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { average_high_f: @temperature.average_high_f, average_low_f: @temperature.average_low_f, month: @temperature.month } }, as: :json
    assert_response 200
  end
